program tdse
implicit none
complex*16 ,dimension(256,5000) :: psi
complex*16 ,dimension(256) :: tmp
real*8,dimension(256) :: x,V
real*8,dimension(5000) :: t
complex*16 :: z
complex*16,dimension(256) :: f_k,if_k
integer :: i,j,k
real*8 :: dx,dt,hc,alpha,x0,p0,m,k0
